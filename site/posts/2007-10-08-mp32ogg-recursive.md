...
So I wrote my own script out of it, which gets the most common tags with id3info and writes them with vorbiscomment into the new OGG file. You can download the script from my [files section](http://files/Scripts/mp32ogg).